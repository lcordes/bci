...
class Bar:
    def __init__(self, timestep, w_size):
        ...
        pygame.display.set_caption("Attention")
    ...
    def redraw_screen(self):
        ...
        bar_length = self.attention * (self.height // 100)
        bar = Rect(
            (self.w_size // 3),
        ...
        pygame.draw.rect(self.window, RED, self.border, 5)
        pygame.draw.rect(self.window, RED, bar)
    ...
    def run(self):
        while True:
            ...
            self.attention = int(self.client.get_command())
